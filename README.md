...
- init(insert+delete test).lua is a beta version with the insert and delete shortcuts. It is very laggy so use at your own risk. If you want to try it, rename it to init and paste in the same directory.
